...
/**
 * @externalId 1419
 * @recipeId 019e97b1-d74d-7666-ab7f-b04ad9231fb8
 * @title Доступно удаление рецепта
 * @description Automatically generated test
 */
test(
  'Доступно удаление рецепта',
  { tag: ['@regression', '@to-automate'] },
  async ({ page }) => {
    testit.workItemIds(['1419']);
    ...
    // Step 2: У любого рецепта нажать кнопку взаимодействия (кебаб)
    // Expected result: доступны действия: Delete для данного рецепта (enabled)
      ...
      try {
        {
          ...
          try {
            await page
              .locator(
                "[data-testid='recipes-list-page'] [role='button']:has-text('Архивация проекта') + div button",
              )
              .click();
    ...
    // Assertion: Действие 'Delete' (Удалить) доступно и активно (enabled) в кебаб-меню рецепта
    await expect(page.locator('text="Удалить"')).toBeEnabled();
