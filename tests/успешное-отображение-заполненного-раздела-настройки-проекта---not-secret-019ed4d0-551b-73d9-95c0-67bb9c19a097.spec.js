...
/**
 * @externalId 547
 * @recipeId 019ed4d0-551b-73d9-95c0-67bb9c19a097
 * @title Успешное отображение заполненного раздела настройки проекта - not secret
 * @description Automatically generated test
 */
test(
  'Успешное отображение заполненного раздела настройки проекта - not secret',
  ...
  async ({ page }) => {
    ...
    // Expected result: Проверить элементы что они отображаются: Заголовок страницы: Project settings Подзаголовок: System under test URL Подазголовок: Environment Data Описание: Add reusable values to use in your tests Кнопка: Add Блоки со всеми типами envData где secret=false(все значения отображаются)
    ...
    // Assertion: Заголовок страницы 'Настройки окружения' (Project settings) отображается
    await expect(
      page.locator(
        "[data-testid='environment-page-page'] > span:has-text('Настройки окружения')",
      ),
    ).toBeVisible();
    // Assertion: Подзаголовок 'URL тестируемого приложения' (System under test URL) отображается
    await expect(
      page.locator(
        "[data-testid='project-settings-container-sut-url'] span:has-text('URL тестируемого приложения')",
      ),
    ).toBeVisible();
    // Assertion: Подзаголовок 'Данные окружения' (Environment Data) отображается
    await expect(
      page.locator(
        "[data-testid='env-data-container'] span:has-text('Данные окружения')",
      ),
    ).toBeVisible();
    // Assertion: Описание 'Add reusable values to use in your tests' отображается под подзаголовком
    await expect(
      page.locator(
        "[data-testid='env-data-container'] span:has-text('Добавьте данные и параметры, которые можно повторно использовать в тестах')",
      ),
    ).toBeVisible();
    // Assertion: Кнопка 'Добавить' (Add) отображается
    await expect(
      page.locator("[data-testid='env-data-button-add']"),
    ).toBeVisible();
    // Assertion: Блок envData 'user' (secret=false) отображается со всеми значениями
    await expect(
      page.locator(
        "[data-testid='env-data-container'] div[data-testid^='env-data-item-card']:has(span:text-is('user'))",
      ),
    ).toBeVisible();
    // Assertion: Значение 'login' отображается в блоке 'user' (не скрыто, т.к. secret=false)
    await expect(
      page.locator(
        "[data-testid='env-data-container'] [data-testid='env-data-item-card-0']:has-text('user') span:has-text('login')",
      ),
    ).toBeVisible();
    // Assertion: Значение 'admin' отображается в блоке 'user' (не скрыто, т.к. secret=false)
    await expect(
      page.locator(
        "[data-testid='env-data-container'] [data-testid='env-data-item-card-0']:has-text('user') span:has-text('admin')",
      ),
    ).toBeVisible();
