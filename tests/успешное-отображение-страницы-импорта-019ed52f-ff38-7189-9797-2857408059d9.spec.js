...
/**
 * @externalId 1451
 * @recipeId 019ed52f-ff38-7189-9797-2857408059d9
 * @title Успешное отображение страницы импорта
 * @description Automatically generated test
 */
test(
  'Успешное отображение страницы импорта',
  { tag: ['@blocker', '@regression', '@smoke', '@to-automate'] },
  async ({ page }) => {
    testit.workItemIds(['1451']);
    ...
    // Assertion: Пользователь авторизован и перенаправлен на страницу проекта
    ...
    // Assertion: В верхней части навигации есть кнопка с иконкой папки и названием проекта
    await expect(
    ...
    // Assertion: Открылась страница /import
    ...
    // Assertion: Кнопка «Сбросить» всегда видна
    await expect(
      page.locator("[data-testid='import-page-top-bar-button-reset']"),
    ).toBeVisible();
    // Assertion: Кнопка «Сбросить» disabled при счетчике = 0
    await expect(
      page.locator("[data-testid='import-page-top-bar-button-reset']"),
    ).toBeDisabled();
    // Assertion: Кнопка «Импортировать» всегда видна
    await expect(
      page.locator("[data-testid='import-page-top-bar-button-import']"),
    ).toBeVisible();
    // Assertion: Кнопка «Импортировать» disabled при счетчике = 0
    await expect(
      page.locator("[data-testid='import-page-top-bar-button-import']"),
    ).toBeDisabled();
    ...
    await expect(page).toHaveURL(new RegExp('\\/import'));
    // Assertion: Заголовок 'Импортировать из TestIT' отображается на странице
    await expect(
      page.locator("h1:has-text('Импортировать из Test IT')"),
    ).toBeVisible();
