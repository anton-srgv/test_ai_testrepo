...
/**
 * @externalId 511
 * @recipeId 019ed52e-3aa1-7128-96f8-6360d4a4c501
...
test(
  ...
  async ({ page }) => {
    ...
    // Assertion: Пользователь авторизован — URL изменился на страницу приложения (не логин)
      ...
      try {
        {
          ...
          try {
            await page.locator("[data-testid='sidebar-button-user']").click();
      ...
      try {
        {
          ...
          try {
            await page
              .locator("[data-testid='sidebar-dropdown-item-logout']")
              .click();
