...
/**
 * @externalId 545
 * @recipeId 019ed4d0-551a-7448-b79e-895cefe8b59d
...
test(
  ...
  async ({ page }) => {
    ...
    // Assertion: В верхней части левой панели отображается кнопка с иконкой папки и названием проекта
    await expect(
      page.locator(
    ...
    // Step 5: Перейти на страницу TMS Connections
    // Expected result: Проверить все элементы на странице, которые видны пользователю.
    // Action: Click on element with data-attribute locator
    await page.waitForTimeout(300);
    ...
    // Assertion: Пользователь находится на странице интеграций
    await expect(page).toHaveURL(new RegExp('\\/settings\\/integrations'));
    // Assertion: Отображается заголовок 'Настройки' в боковой панели
    await expect(page.locator('aside > div > span')).toHaveText('Настройки');
    // Assertion: Отображается пункт навигации 'Настройки окружения'
    await expect(
      page.locator("[data-testid='settings-aside-nav-item-environment']"),
    ).toBeVisible();
    // Assertion: Пункт навигации 'Интеграции' отображается (активный)
    await expect(
      page.locator("[data-testid='settings-aside-nav-item-integrations']"),
    ).toBeVisible();
    // Assertion: Отображается пункт навигации 'Участники'
    await expect(
      page.locator("[data-testid='settings-aside-nav-item-members']"),
    ).toBeVisible();
    // Assertion: Отображается заголовок страницы 'Интеграции с TMS'
    await expect(
      page.locator("[data-testid='integrations-page'] h1"),
    ).toHaveText('Интеграции с TMS');
    // Assertion: Отображается описание 'Подключите ваши системы управления тестированием для автоматического импорта тест-кейсов'
    await expect(
    ...
    // Assertion: Отображается название интеграции 'Test IT'
    await expect(
      page.locator(
        "[data-testid='tms-integrations-list-list'] h3:has-text('Test IT')",
      ),
    ).toBeVisible();
    // Assertion: Отображается описание карточки 'Синхронизируйте проект с Test IT'
    await expect(
      page.locator(
        "[data-testid='tms-integrations-list-list'] p:has-text('Синхронизируйте проект с Test IT')",
      ),
    ).toBeVisible();
    // Assertion: Отображается кнопка 'Отключить' в карточке Test IT
    await expect(
      page.locator(
        "[data-testid='tms-integrations-list-list'] button:has-text('Отключить')",
      ),
    ).toBeVisible();
    // Assertion: Иконка настроек отображается в боковой навигации
    await expect(
      page.locator("[data-testid='sidebar-nav-item-settings']"),
    ).toBeVisible();
