...
/**
 * @externalId 1400
 * @recipeId 019e6d42-22bf-72e9-9c47-a9a70e1fe5a4
 * @title Успешная авторизация подтвержденного пользователя
 * @description Automatically generated test
 */
test(
  'Успешная авторизация подтвержденного пользователя',
  { tag: ['@regression', '@smoke', '@to-automate'] },
  async ({ page }) => {
    testit.workItemIds(['1400']);
    ...
    // Step 2: Заполнить поле email рандомным значением
    ...
    // Step 3: Заполнить поле password рандомным значением
    // Expected result: Значение в поле password замаскировано;
    // Action: Input variable value into element with data-attribute
    await page.waitForTimeout(300);
    ...
    // Assertion: Значение в поле password замаскировано — тип поля должен быть 'password', что обеспечивает маскировку введённых символов
    await expect(
    ...
    // Assertion: Пользователь авторизован — произошёл переход со страницы логина на /recipes
